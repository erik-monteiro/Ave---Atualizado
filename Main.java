            ...
            switch(opcao) {
                ...
                case 4:
                    ...
                    switch(opcaoCaracteristica) {
                        ...
                        case 5:
                            System.out.println("\f");
                            System.out.println("Digite o local onde você está vendo esta ave: ");
                        ...
                        case 7:
                            System.out.println("\f");
                            System.out.println("Pesquisa sua ave pelo catálogo. Digite a página, linha e coluna (respectivamente) onde a ave desejada está presente: ");
                            String paginaAve = entrada.next();
                            String linhaAve = entrada.next();
                            String colunaAve = entrada.next();
                            i=10;
                            while(i!=10){
                                for (i = 0; i < aves.length; i++) {
                                    if (aves[i].getPagina().contains(paginaAve.toLowerCase())&&
                                    aves[i].getLinha().contains(linhaAve.toLowerCase()) &&
                                    aves[i].getColuna().contains(colunaAve.toLowerCase())){
                                        System.out.printf("%2d - %s%n", i+1, aves[i].getNomePortugues());	
                                    }
                                }
                            }
